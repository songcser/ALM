	...
	<tr>
		...
		<div class="dtree" id="dtree1" style="height:700px;overflow:auto">
    		...
    		<script type="text/javascript">
				...
				var node = new Node(<%=arts.getId() %>,0,'<%=arts.getName() %>','ArtifactServlet?tabName=t1&flag=select&artId=<%= arts.getId() %>&artName=<%=arts.getName() %>');
				node._hc = true;
					...
					<% 
					 ...
					 <table id="idData" border=1 width="550px" align="center">
    					...
    					<%
      					...
      					%>
    					<tr>
    						<td width="150px"><a href="LibraryServlet?tabName=t1&flag=download&libId=<%=lib.getId() %>&libName=<%=lib.getName() %>"><%=lib.getName() %></a></td>   	
