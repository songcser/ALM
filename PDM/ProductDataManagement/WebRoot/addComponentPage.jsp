...
<html>
  <head>
	...
	function init(){
		...
		var url = "ProductVersionServlet?flag=getComponentCategory";
		...
		if(retStr){
			...
			url = "ProductVersionServlet?flag=getComponents&categoryName="+name[0];
	...
	function selectCategory(){
		...
		var url = "ProductVersionServlet?flag=getComponents&categoryName="+name;
		//alert(url);
		var retStr = ajaxSend(url,false);
		//alert(retStr);
		if(retStr){
  ...
  <p>&nbsp;</p>
  	...
  	<center>
    <div style="width:90%">
    	Component Category : <select id="categoryList" style="width:250px" onchange="selectCategory()">
    	</select>
    </div>
    <p>&nbsp;</p>
    <p>Components</p>
    <table>
    <tr><td>
     <input type="submit" value="Add" style="width:60px;align:right" onclick="addComponent()" >
     </td>
     </tr>
    <tr>
    <td>
    ...
    <div style="height:300px;overflow:auto;" >
    	<table id="components" border=1 width="400px"> 
    		<tr bgcolor=Orange>
    			<td width="10"> </td>
