...
<tr>
	...
	<iframe src="componentLeftPage.jsp" id="leftFrame" name="leftFrame" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" style="width:100%; height:100%; overflow:no"></iframe>
	
	</td>
	<td height="700px" colspan=3 width="750px">
	<iframe src="componentContentPage.jsp" id="contentFrame" name="contentFrame" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" style="width:100%; height:100%; overflow:no"></iframe>		
  	</td>
