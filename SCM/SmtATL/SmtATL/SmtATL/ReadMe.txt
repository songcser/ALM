========================================================================
    ACTIVE TEMPLATE LIBRARY : SmtATL Project Overview
========================================================================

AppWizard has created this SmtATL project for you to use as the starting point for
...
SmtATL.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (SmtATL.h)
        GUID definitions                                (SmtATL_i.c)
        A type library                                  (SmtATL.tlb)
        Marshaling code                                 (SmtATL_p.c and dlldata.c)

SmtATL.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in SmtATL.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named SmtATL.pch and a precompiled types file named StdAfx.obj.
...
SmtATLps.vcxproj
	...
	dlldata.c, SmtATL_i.c and SmtATL_p.c which are required
	to build the proxy/stub DLL.

SmtATLps.vcxproj.filters
